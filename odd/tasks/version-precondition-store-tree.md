...
**W4 `store-locations` remains**, and then **W5**, which closes this record with the terminal header and
the evidence log for all four slices. Per-slice detail and the measured evidence live in
`## Evidence log`.
**Created**: 2026-09-26
