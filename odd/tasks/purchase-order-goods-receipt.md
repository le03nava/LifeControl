...
> **Superseded by `odd/tasks/sales-location-aware-stock.md`** (created 2026-09-24), which owns this
> workstream and supersedes W3-3. The section below stays frozen as the record of the deferral, including
> the pre-V14 anchors it was written with.
