...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/actuator/**").access(this::isInternalClient)
     ...
     */
    private AuthorizationDecision isInternalClient(Supplier<Authentication> authentication,
                                                   RequestAuthorizationContext context) {
        var clientIp = ClientIpResolver.resolve(context.getRequest(), accessProperties.getTrustedProxies());
        var allowed = clientIp != null && accessProperties.getActuatorAllowedCidrs().stream()
