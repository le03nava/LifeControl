-- ============================================
-- V1 — Baseline Schema (LifeControl API)
-- ============================================
-- Full schema in dependency order. This is the single source of truth,
-- replacing both docker/init-scripts/01-init-schema.sql and schema.sql.
-- ============================================
...
CREATE INDEX idx_cc_company ON company_countries(company_id);
CREATE INDEX idx_cc_country ON company_countries(country_id);
...
CREATE INDEX idx_cr_company_country ON company_regions(company_country_id);
...
CREATE INDEX idx_cz_region ON company_zones(company_region_id);
...
CREATE INDEX idx_company_stores_company_zone_id ON company_stores(company_zone_id);
CREATE INDEX idx_company_stores_address_id ON company_stores(address_id);
...
CREATE INDEX idx_activity_logs_process ON activity_logs(activity_process_id);
CREATE INDEX idx_activity_logs_event ON activity_logs(activity_event_id);
...
CREATE INDEX idx_status_types_name ON status_types(status_type_name);
...
CREATE INDEX idx_statuses_type ON statuses(status_type_id);
...
CREATE INDEX idx_measure_units_sat_code ON measure_units(sat_code);
CREATE INDEX idx_measure_units_type ON measure_units(unit_type);
...
CREATE INDEX idx_payment_methods_name ON payment_methods(payment_method_name);
...
CREATE INDEX idx_po_store ON purchase_orders(company_store_id);
CREATE INDEX idx_po_payment_method ON purchase_orders(payment_method_id);
CREATE INDEX idx_po_status ON purchase_orders(status_id);
CREATE INDEX idx_po_enabled ON purchase_orders(enabled);
...
CREATE INDEX idx_pod_status ON purchase_order_details(status_id);
CREATE INDEX idx_pod_enabled ON purchase_order_details(enabled);
...
CREATE INDEX idx_up_keycloak_user ON user_preferences(keycloak_user_id);
...
CREATE UNIQUE INDEX idx_product_variants_bar_code ON product_variants(bar_code);
CREATE INDEX idx_product_variants_product ON product_variants(product_id);
CREATE INDEX idx_product_variants_store ON product_variants(company_store_id);
CREATE INDEX idx_product_variants_sku ON product_variants(sku);
CREATE INDEX idx_product_variants_enabled ON product_variants(enabled);
...
CREATE UNIQUE INDEX idx_promotions_coupon_code ON promotions(coupon_code);
CREATE INDEX idx_promotions_name ON promotions(promotion_name);
CREATE INDEX idx_promotions_dates ON promotions(start_date, end_date);
CREATE INDEX idx_promotions_sales_channel ON promotions(sales_channel);
...
CREATE INDEX idx_shifts_store ON shifts(company_store_id);
CREATE INDEX idx_shifts_status ON shifts(status);
CREATE INDEX idx_shifts_opened_at ON shifts(opened_at);
CREATE INDEX idx_shifts_enabled ON shifts(enabled);
...
CREATE INDEX idx_so_store ON sales_orders(company_store_id);
CREATE INDEX idx_so_shift ON sales_orders(shift_id);
CREATE INDEX idx_so_status ON sales_orders(status_id);
CREATE INDEX idx_so_payment_method ON sales_orders(payment_method_id);
CREATE INDEX idx_so_enabled ON sales_orders(enabled);
...
CREATE INDEX idx_soi_variant ON sales_order_items(product_variant_id);
CREATE INDEX idx_soi_promotion ON sales_order_items(promotion_id);
CREATE INDEX idx_soi_status ON sales_order_items(status_id);
CREATE INDEX idx_soi_enabled ON sales_order_items(enabled);
