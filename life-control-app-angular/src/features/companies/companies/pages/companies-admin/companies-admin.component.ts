...
const STATIC_CARDS: Omit<DashboardCard, 'disabled'>[] = [
  ...
  },
  {
    title: 'Store Areas',
    icon: 'account_tree',
    description: 'Manage the physical areas of your stores.',
    route: '/companies/store-areas',
    requiredRoles: [
      'lc-admin',
      'lc-company',
      'lc-company-country',
  ...
  },
  {
    ...
    icon: 'shelves',
    description: 'Manage the physical locations inside each store zone.',
    route: '/companies/store-locations',
    requiredRoles: [
      'lc-admin',
      'lc-company',
      'lc-company-country',
